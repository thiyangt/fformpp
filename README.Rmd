...
More about Efficient Bayesian Multivariate Regression: see the linked packages [flutils](https://github.com/feng-li/flutils) and [movingknots](https://github.com/feng-li/movingknots) 
by [Feng Li](https://github.com/feng-li)
